...
const navLinks = [
  ...
  { name: "Technical", href: "#tech-stack" },
  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="pointer-events-auto px-4 py-2 rounded-full border border-white/10 bg-zinc-900/60 backdrop-blur-xl shadow-2xl flex items-center gap-2.5 hover:bg-zinc-800/80 transition-colors"
      >
        <Image src="/logo.png" alt="KD Logo" width={36} height={36} />
        <span className="text-sm font-bold tracking-tight leading-none">
          <span className="text-amber-500">KTD</span>
