...
import { UserRole, RolePermission, PermissionMatrix } from "@/features/crm/types/crm";
import { 
  Users, 
  UserPlus, 
  Check, 
...
export default function CrmRbacManager() {
  ...
  const [deleteConfirmTarget, setDeleteConfirmTarget] = useState<import('@/features/crm/types/crm').StaffUser | null>(null);
